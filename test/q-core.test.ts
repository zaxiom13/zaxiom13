...
const GOLDEN: [string, string][] = [
  ...
  ['sums 1 2 3', '1 3 6'],
  ['deltas 1 3 6', '1 2 3'],
  ['deltas[10;15 27 93]', '5 12 66'],
  ['avg (1;0n;2;3)', '1.5'],
  ['2 0N 4 5 wavg 1 2 0N 8', '6f'],
  ['3#1 2', '1 2 1'],
  ['-2#til 5', '3 4'],
  ['2_til 5', '2 3 4'],
  ['2 3#til 6', '0 1 2\n3 4 5'],
  ...
  ['5 within (1 2 6;3 5 7)', '010b'],
  ['5 xbar 0 3 7 11', '0 0 5 10'],
  ['"," sv ("ab";"cd")', '"ab,cd"'],
  ['"," vs "ab,cd"', '"ab"\n"cd"'],
  ['string 42', '"42"'],
  ['string `a`b', '"a"\n"b"'],
  ['("the";"quick";;"fox")"brown"', '"the"\n"quick"\n"brown"\n"fox"'],
  ['trim 0N 0N 1 2 3 0N', '1 2 3'],
  ['"H"$"32768"', '0Nh'],
  ['"I"$"192.168.1.34"', '-1062731486i'],
  ['signum -2 0 1 3', '-1 0 1 1i'],
