  ...
  host.append(
    ...
    el('div', {
      ...
      html: [
        ...
        ['position', 'p (2-vector)  ·  p2 p3 for line/tri  ·  pts for path/poly'],
        ...
        ['mouse', '.p5.mp .p5.down .p5.clicks .p5.mouse .p5.touch'],
        ['keyboard', '.p5.keys .p5.key · pressed `w · pressed `left`right'],
        ['canvas', '.p5.t .p5.f .p5.w .p5.h .p5.wh .p5.cp · bg `colour'],
